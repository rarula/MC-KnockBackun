#> knockbackun:mob/core/facing/neutral/distance/facing
#
# Facing条件指定部分
#
...
# facing
    execute as @s at @s facing entity @e[tag=Neutral_AEC_KnockBack,sort=nearest,limit=1] eyes run tp @s ~ ~ ~ ~180 0
